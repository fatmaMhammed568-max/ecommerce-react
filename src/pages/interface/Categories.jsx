...
import { FaFolder, FaBox, FaArrowLeft } from 'react-icons/fa';
import { motion } from 'framer-motion';
import toast from 'react-hot-toast';

/**
 * صفحة عرض جميع الأقسام (للمستخدم العادي)
 */
const Categories = () => {
  ...
  const handleImageError = (e) => {
    e.target.src = 'https://via.placeholder.com/600x400/0284c7/ffffff?text=Category';
  };

  const getCategoryImage = (image) => {
    if (!image) return 'https://via.placeholder.com/600x400/0284c7/ffffff?text=Category';
      ...
      <div className="container-custom">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            استعرضي منتجاتنا حسب الأقسام المختلفة للعناية ببشرتك
          </p>
        </div>
            ...
            {categories.map((category) => (
              ...
              >
                <Link
                  ...
                  className="group relative bg-white rounded-2xl shadow-lg overflow-hidden block focus:outline-none focus:ring-2 focus:ring-primary-500"
                >
