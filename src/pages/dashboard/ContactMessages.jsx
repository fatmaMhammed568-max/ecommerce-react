        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-gradient-to-l from-primary-600 to-skin-600 px-6 py-4 text-white flex justify-between">
              ...
              <button onClick={() => setShowViewModal(false)} className="hover:text-gray-200">
                <FaTimes />
              </button>
            </div>
            ...
            <div className="p-6">
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="font-semibold flex items-center gap-2" dir="ltr">
                    <FaEnvelope className="text-primary-600" />
              ...
              <div className="mb-6">
                ...
                <p className="font-semibold p-3 bg-gray-50 rounded-lg flex items-center gap-2">
              ...
              <div className="mb-6">
                ...
                <div className="p-4 bg-gray-50 rounded-lg whitespace-pre-line">
                  <MdMessage className="w-5 h-5 text-primary-600 mb-2" />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-lg">
            <div className="sticky top-0 bg-gradient-to-l from-primary-600 to-skin-600 px-6 py-4 text-white flex justify-between">
              ...
              <button onClick={() => setShowReplyModal(false)} className="hover:text-gray-200">
                <FaTimes />
              </button>
            </div>
            ...
            <div className="p-6">
              <p className="mb-4 text-gray-700">
                الرد على: <span className="font-semibold">{selectedMessage.email}</span>
              </p>
